...
-- Started on 2025-02-28 22:59:09
...
--
-- TOC entry 219 (class 1259 OID 24756)
...
--
-- TOC entry 4748 (class 2604 OID 24760)
...
--
-- TOC entry 4747 (class 2604 OID 24753)
...
--
-- TOC entry 4902 (class 0 OID 24757)
-- Dependencies: 220
-- Data for Name: assignments; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.assignments (assignment_id, title, description, due_date, student_id) FROM stdin;
2	Lab7 PostgreSQL	Set up a database and insert records as described in the instructions.	2025-02-28	1
\.


--
-- TOC entry 4900 (class 0 OID 24750)
-- Dependencies: 218
-- Data for Name: students; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.students (student_id, first_name, last_name, email, enrollment_date) FROM stdin;
1	Joshua	Goldner	jmgoldner@my.waketech.edu	\N
\.
...
--
-- TOC entry 4752 (class 2606 OID 24764)
...
--
-- TOC entry 4750 (class 2606 OID 24755)
...
--
-- TOC entry 4753 (class 2606 OID 24765)
...
-- Completed on 2025-02-28 22:59:09
